...
if staffelung_3a:
    staffelungsjahre_3a = st.multiselect("Bezug Jahre für 3a", [f"{rentenbeginn_58+i}/{rentenbeginn_58+i}" for i in range(0, rentenbeginn_70 - rentenbeginn_58 + 1)])

staffelung_bvg = st.checkbox("BVG gestaffelt beziehen?")
if staffelung_bvg:
    staffelungsjahre_bvg = st.multiselect("Bezug Jahre für BVG", [f"{rentenbeginn_58+i}/{rentenbeginn_58+i}" for i in range(0, rentenbeginn_70 - rentenbeginn_58 + 1)])
